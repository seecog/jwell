    ...
    $.fn.amazingslider = function(options) {
        ...
        this.each(function() {
            ...
            if ($(this).data("textformat") && typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== "undefined")
                if ($(this).data("textformat") in AMAZINGSLIDER_TEXT_EFFECT_FORMATS) this.options =
            ...
            var defaultOptions = {
                ...
                wtextcssdefault: "",
                winkcssdefault: "text-decoration:none;font:12px Arial,Tahoma,Helvetica,sans-serif;color:#333;display:none;"
            };
